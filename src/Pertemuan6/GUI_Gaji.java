...
public class GUI_Gaji extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(cmb_jabatan.getSelectedIndex()==0){
            ...
            txt_gatot.setText(Integer.toString(obj.Gaji(Integer.parseInt(txt_hadir.getText()))));
        }
        else{
            txt_gatot.setText(Integer.toString(obj.Gaji(Integer.parseInt(txt_hadir.getText()), Integer.parseInt(txt_lembur.getText()))));
        }
