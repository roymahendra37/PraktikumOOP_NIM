...
public class GUI_Gaji extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txt_gatot, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Sekretaris skr = new Sekretaris();
        Manager mng = new Manager();
        int hadir=0;
        int lembur=0;
        //exception handling
        try{
            hadir = Integer.parseInt(txt_hadir.getText());
            lembur = Integer.parseInt(txt_lembur.getText());
        }
        catch (Exception e){
            JOptionPane.showMessageDialog(null, "Input Data Berupa Angka!");
        }
        finally {
        ...
        if(cmb_jabatan.getSelectedIndex()==0){
            txt_gatot.setText(Integer.toString(kry.hitGaji(hadir, lembur)));
            cetak.append("Jabatan : "+kry.jabatan()+"\n");
            cetak.append(kry.info());
        }
        else if(cmb_jabatan.getSelectedIndex()==1){
            txt_gatot.setText(Integer.toString(skr.hitGaji(hadir, lembur)));
            cetak.append("Jabatan : "+skr.jabatan()+"\n");
            cetak.append(skr.info());
        }
        else{
            txt_gatot.setText(Integer.toString(mng.hitGaji(hadir, lembur)));
            cetak.append("Jabatan : "+mng.jabatan()+"\n");
            cetak.append(mng.info());
        }   
